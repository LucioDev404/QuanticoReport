...
<body>
    ...
    <div class="container mt-5">
        <div class="box mb-5">
            <h1 class="text-center text-dark">Visuallizza Report</h1>
            <div class="row mt-3">
                <div class="col-md-4">
                    <?php

                    //creazione dei bottoni per aprire i tab
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "
                            <div class='row'>
                                <a href='./viewAllReport.php?search=$row[nome_reparto]' class='btn btn-primary mb-3'>$row[nome_reparto]</a>
                            </div>
                            ";
                        }
                    }
                ...
                <div class="col-md-8">
                    ...
                    if (isset($_GET['search'])) {
                        echo "
                                <h3 class='text-dark'>Report: $_GET[search]</h3>
                            ";
                    }
                    ?>
                    <div class="container-report">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search'])) {
                                    $reparto = $_GET['search'];
                                    $query    = "SELECT * FROM `Report` WHERE `reparto` = '" . $reparto . "' ORDER BY `id` DESC";
                            ...
                            <div class='alert alert-info' role='alert'>
                                Selezionare il reparto da visualizzare!
                            </div>
                            ";
                                }
